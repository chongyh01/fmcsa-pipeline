"""
_generate_batch04.py
====================
Batch 04 — 30 random carrier reports for external audit (ChatGPT consistency check).

Excludes:
  - 23 gold_carriers.json DOTs
  - 30 DOTs from batch 01
  - 30 DOTs from batch 02
  - 30 DOTs from batch 03

Output:
  CODES/04 - Carrier Report 1st July 2026/DOT_<number>.txt
  CODES/04 - Carrier Report 1st July 2026/manifest.csv

Usage:
    python _generate_batch04.py
"""
...
OUTPUT_DIR = Path(__file__).parent / "04 - Carrier Report 1st July 2026"
...
GOLD_DOTS = {
    ...
    # Round 3
    "1074419", "31047", "810652", "973209", "4275752", "3128165", "1864365", "2833702",
}
...
BATCH03_DOTS = {
    "3318511","1065078","616218","3393760","2455782","2585681","3183794","3377734",
    "2567251","31047","4260894","810652","3285049","1111564","3511334","1582146",
    "4023511","3000089","4275752","2174951","973209","1864365","2833702","966390",
    "1862174","960311","1875715","404543","3128165","3910116",
}

EXCLUDE = GOLD_DOTS | BATCH01_DOTS | BATCH02_DOTS | BATCH03_DOTS
...
def main():
    ...
    print(f"Sampling {N_TARGET} DOTs for batch 04...")
    dots = sample_30(conn)
    ...
    for r in manifest_rows:
        ...
        print(f"  DOT {r['dot_number']:<10} {r['carrier_type']:<35} "
              f"fleet={r['fleet_power_units']:<5} {r['legal_name'][:30]}{flag}")
